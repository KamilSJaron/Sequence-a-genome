...
Both IGV and R you will be run locally, so let me suggest you an organisation of the files, that I will use. If you will use the same, you will have much less work with reusing of the code in this assignment and also it will simplify problem diagnostics to your assistants. The most common problems are the problems with path caused by messy organisation.
...
Your R should have version 3.2.4 or 3.2.5. In case it is not, please install it.

In case your OS/Linux/Windows is on French, we kindly ask to change settings of R to English. The reason for this are the error messages that are not googlable, or understandable to all asistants on French. Thank you for understanding.
