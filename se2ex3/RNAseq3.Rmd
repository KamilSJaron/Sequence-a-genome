...
3. Load function `tximport` from script `tximport.R`. You can download the script from `/scratch/cluster/monthly/mls_2015/SAGE/scripts/tximport.R`. We will use this function to load transcript abundances
...
colnames(txi$counts) <- substr(files,nchar(path_to_abundances)+1,nchar(path_to_abundances)+3)
# paste(rep(c('LM','SA','WL','WR'), each = 4), rep(1:4,4),sep='') #if you would load all 16 files
```
...
list of genes I ve anotated -> list of expressions of those genes.
