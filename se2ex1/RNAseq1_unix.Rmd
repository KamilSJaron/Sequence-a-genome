...
1. Once, it will be done, copy all fastqc results to your computer. It will take from 10 to 30 minutes (depens on the size of your biological replicate).
...
3. Edit the script `vi sag_trimming_job.sh`, put there. Is the adapter sequence correct?
4. Submit a trimming job (this will take some hours)
