...
4. `fastqc` computes a quality control and outputs it to output folder defined by parameter `-o`. 

```bash
fastqc <sequencing_reads> –o <fastqc_results>
```

5. Now you should be able to submit a job computing a quality control of reads in `NEED TO BE ADDED` file.
