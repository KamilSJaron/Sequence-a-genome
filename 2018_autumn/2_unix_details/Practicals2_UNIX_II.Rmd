...
We already know basics of unix. You know how to write commands that perform basic operations on files. We have also learned that some of the symbols are special and mean something (like `|`, `>`, etc.). Now we would like to explore more of these characters.
...
`bash` have performed all possible expansions on the `what ever I want *.Rmd $HOME` and then `echo` printed it. To understand what actually have just happened just continue in the practicals.
