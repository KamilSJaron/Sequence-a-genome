...
2. Copy your reads (`/scratch/beegfs/monthly/mls_2017/data/raw_reads/<sample>_R[12].fastq.gz`) to your scratch.

The list of samples and corresponding group numbers (if your group is not listed, feel free to take any one you like) :

```{R, echo = F}
samples <- c('ESL0366','ESL0367','ESL0368','ESL0378','ESL0379','ESL0380','ESL0382','ESL0385','ESL0387','ESL0390','ESL0392')
data.frame(sample = samples, group = 1:11)
```
...
```bash
bsub -n 8 -M 4194304 -J <job_name> 'SAMPLE=<sample>;
